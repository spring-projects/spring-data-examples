...
/**
 * Integration test for {@link RxJava2PersonRepository} using RxJava1 types. Note that {@link ReactiveMongoOperations}
...
public class RxJava2PersonRepositoryIntegrationTest {
	...
	public void setUp() {
		...
		repository
				.saveAll(Flowable.just(new Person("Walter", "White", 50), //
