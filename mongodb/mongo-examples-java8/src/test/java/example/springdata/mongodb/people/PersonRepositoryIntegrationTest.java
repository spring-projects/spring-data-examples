...
public class PersonRepositoryIntegrationTest {
	...
	public void setUp() {
		...
		dave = repository.save(new Person(null, "Dave", "Matthews"));
		oliver = repository.save(new Person(null, "Oliver August", "Matthews"));
		carter = repository.save(new Person(null, "Carter", "Beauford"));
	}
