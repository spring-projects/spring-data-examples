...
public class ApplicationConfiguration {
	...
	CommandLineRunner init(MongoTemplate template) {
		...
		return (args) -> {
			...
			template.indexOps(SWCharacter.class).ensureIndex(new GeospatialIndex("homePlanet.coordinates")
					.typed(GeoSpatialIndexType.GEO_2DSPHERE).named("planet-coordinate-idx"));
