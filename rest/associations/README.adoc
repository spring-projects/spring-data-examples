...
For example, given parent entity "Parent" and child entity "Child", you can create both records with a single HTTP call, like this:

.Sample HTTP Call to create parent and child records:
====
[source,bash]
----
...
- HTTP Method: POST
- URL: /api/parents (or your configured root path)
