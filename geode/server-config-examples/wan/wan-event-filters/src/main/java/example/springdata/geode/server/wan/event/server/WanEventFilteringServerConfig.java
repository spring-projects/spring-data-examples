...
import example.springdata.geode.server.wan.event.server.siteB.SiteBWanEventFilteringServerConfig;
...
@Import({SiteAWanEnabledServerConfig.class, SiteBWanEventFilteringServerConfig.class})
public class WanEventFilteringServerConfig {
	@Bean
	Faker faker() {
		return new Faker();
	}
