...
import example.springdata.geode.server.wan.transport.server.siteA.SiteAWanEnabledServerConfig;
import example.springdata.geode.server.wan.transport.server.siteB.SiteBWanTransportListenerServerConfig;
...
@Import({SiteAWanEnabledServerConfig.class, SiteBWanTransportListenerServerConfig.class})
public class WanTransportListenerServerConfig {
	@Bean
	Faker faker() {
		return new Faker();
	}
