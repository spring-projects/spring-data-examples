...
import example.springdata.geode.server.wan.substitution.client.WanClientConfig;
import example.springdata.geode.server.wan.substitution.server.WanEventSubstitutionFilterServer;
...
public class WanEventSubstitutionFilterServerTest extends ForkingClientServerIntegrationTestsSupport {
	...
	public static void setup() throws IOException {
		...
		startGemFireServer(WanEventSubstitutionFilterServer.class, "-Dspring.profiles.active=SiteA");
