...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.NONE, classes = CacheDefinedExpirationServer.class)
@DirtiesContext(classMode = DirtiesContext.ClassMode.AFTER_CLASS)
public class CacheDefinedExpirationServerTest {
