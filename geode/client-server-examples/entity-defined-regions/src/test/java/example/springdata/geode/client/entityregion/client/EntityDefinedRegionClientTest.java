...
package example.springdata.geode.client.entityregion.client;

import example.springdata.geode.client.entityregion.Customer;
import example.springdata.geode.client.entityregion.EmailAddress;
