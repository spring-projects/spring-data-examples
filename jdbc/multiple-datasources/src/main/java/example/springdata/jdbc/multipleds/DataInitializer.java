 ...
 */
package example.springdata.jdbc.multipleds;
...
import example.springdata.jdbc.multipleds.customer.CustomerRepository;
import example.springdata.jdbc.multipleds.order.Order;
import example.springdata.jdbc.multipleds.order.Order.LineItem;
import example.springdata.jdbc.multipleds.order.OrderRepository;
